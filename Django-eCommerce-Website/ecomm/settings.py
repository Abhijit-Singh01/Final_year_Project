...
# SECRET_KEY = config("SECRET_KEY",default="unsafe-test-secret-key")

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = config("DEBUG")


SECRET_KEY = '-1yffh+$ut$fu7*(=%c!2@qtr+-bfv1!jxbo0n+3@!n!c5+*5$'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "abhijitsingh11100@gmail.com"
EMAIL_HOST_PASSWORD = 'tsvt ihky rree kprm'
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
EMAIL_USE_SSL = False


# RazorPay API KEYS
RAZORPAY_KEY_ID ='rzp_test_SELfG8tZWaOSXs'
RAZORPAY_SECRET_KEY ='X6abDgZCPfBJ2ttzXdw2Bjog'
